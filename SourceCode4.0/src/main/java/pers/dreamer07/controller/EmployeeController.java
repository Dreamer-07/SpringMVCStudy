...
public class EmployeeController {
    ...
    @RequestMapping(value = "toAddPage",method = RequestMethod.GET)     //前往添加页面查询部门信息
    ...
    @RequestMapping(value = "qctEmp",method = RequestMethod.POST) //快速添加员工
    public String qctAddEmp(@RequestParam("empInfo") Employee employee){
